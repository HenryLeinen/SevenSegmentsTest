...
HD_PWD='D:/Repositories/FPGA/Xilinx/Vivado/SevenSegmentsTest/SevenSegmentsTest.runs/Main_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_axi_gpio_0_0.tcl
