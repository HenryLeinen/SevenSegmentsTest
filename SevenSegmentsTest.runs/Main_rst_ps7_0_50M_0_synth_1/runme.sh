...
HD_PWD='D:/Repositories/FPGA/Xilinx/Vivado/SevenSegmentsTest/SevenSegmentsTest.runs/Main_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_rst_ps7_0_50M_0.tcl
