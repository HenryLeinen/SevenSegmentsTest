...
HD_PWD='D:/Repositories/FPGA/Xilinx/Vivado/SevenSegmentsTest/SevenSegmentsTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Main_wrapper.tcl -notrace
